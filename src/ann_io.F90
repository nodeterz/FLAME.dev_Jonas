...
subroutine write_ann_all(parini,ann_arr,iter)
    ...
    elseif(trim(ann_arr%approach)=='eem1' .or. trim(ann_arr%approach)=='cent1' .or. &
           trim(ann_arr%approach)=='cent2' .or. trim(ann_arr%approach)=='centt') then
        do i=1,ann_arr%nann
        ...
        stop 'ERROR: writing ANN parameters is only for cent1,cent2,centt,tb'
    endif
...
subroutine read_ann(parini,ann_arr)
    ...
    do iann=1,ann_arr%nann
        ...
        elseif(trim(ann_arr%approach)=='eem1' .or. trim(ann_arr%approach)=='cent1' .or. &
            ...
            stop 'ERROR: reading ANN parameters is only for cent1,cent2,centt,tb'
        endif
